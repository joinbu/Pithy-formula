...
R = pd.DataFrame([
'地下水较少的软弱破碎围岩的隧道工程中，如土砂质地层、弱膨胀性地层、流变性较小的地层、裂隙发育的岩体、断层破碎带、浅埋无显著偏压的隧道等，也适宜于采用中小型机械施工',

'围岩压力来得快、来得大，用于对围岩变形及地表下沉有较严格限制要求的软弱破碎围岩隧道工程中，如土砂质地层、强膨胀性地层、强流变性地层、裂隙发育的岩体、断层破碎带、浅埋有显著偏压等围岩的隧道中',

'一般软弱破碎围岩，也适用于地下水丰富的松软围岩。',

'有压地下水及地下水丰富的地层中，也更适用于采用大中型机械化施工。',
